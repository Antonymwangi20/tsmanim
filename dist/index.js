...
export { Move } from './core/animations/Move.js';
export { Transform } from './core/animations/Transform.js';
export { AdvancedMove } from './core/animations/AdvancedMove.js';
export { KeyframeTrack, cubicBezier, catmullRom, hermite } from './core/animations/Keyframe.js';
export { SpringAnimation, SpringPhysics, SpringPresets } from './core/animations/physics/Spring.js';
// Shapes
export { Circle } from './core/shapes/Circle.js';
export { Rect } from './core/shapes/Rect.js';
export { Text } from './core/shapes/Text.js';
export { SVGPath } from './core/shapes/SVGPath.js';
// Renderers
...
export { PostProcessStack } from './core/renderer/PostProcess.js';
// Effects
export { ParticleSystem } from './core/effects/ParticleSystem.js';
// Utilities
export { Vector2 } from './core/utils/Vector2.js';
export { Easing } from './core/utils/Easing.js';
...
Dimension, Point2D, Point3D, Point4D, Vec2D, Vec3D, Vec4D, MobjectConfig, Mobject, Mobject2D, Mobject3D, Mobject4D, MobjectGroup, TrackedValue, ValueChangeListener, is2D, is3D, is4D, validateHierarchy, 
// Decorators
Scene as SceneDecorator, SceneConfig as DecoratorSceneConfig, Track, TrackConfig, EntryPoint, Cached, CacheConfig, Property, PropertyConfig, Constraint as ConstraintDecorator, ConstraintConfig, Validator, extractDecoratorMetadata, 
// Constraints
ConstraintInterface, ConstraintValue, EqualityConstraint, IncidenceConstraint, TangencyConstraint, DistanceConstraint, ConstraintSolver, ConstraintBuilder } from './v2/index.js';
// ============================================================================
// Plugins (Optional, tree-shakeable)
// ============================================================================
// GPU Plugin
export { SkiaGPUPlugin, GPUCompute, ShaderBuilder, ShaderPresets } from './plugins/gpu/index.js';
// AI Plugin
export { AIPlugin, AnimationAI, animationAI } from './plugins/ai/index.js';
// Cloud Plugin
export { CloudPlugin, CloudInfrastructure, createCloudInfrastructure, RenderOrchestrator, AWSRenderBackend, GCPRenderBackend } from './plugins/cloud/index.js';
// Collaborative Plugin
export { CollaborativeServer, setupCollaborativeServer, CollaborativeSession, createCollaborativeSession } from './plugins/collab/index.js';
