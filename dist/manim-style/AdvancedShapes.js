 ...
 * Create an ellipse
 */
export function createEllipse(center, width, height, config) {
    const a = width / 2;
    const b = height / 2;
    const steps = 100;
    let pathData = '';
 ...
 */
export function createSector(center, radius, startAngle, endAngle, config) {
    const start = [
 ...
 * Create dashed line
 */
export function createDashedLine(start, end, dashLength = 5, gapLength = 5, config) {
 ...
 * Create arrow
 */
export function createArrow(start, end, config) {
 ...
 */
export function createDoubleArrow(start, end, config) {
    const headlen = config?.headLength ?? 15;
    const angle = Math.atan2(end[1] - start[1], end[0] - start[0]);
    const pathData = `
 ...
 */
export function createDot(center, radius = 3, config) {
    const pathData = `
 ...
 */
export function createCross(center, size = 20, config) {
    const half = size / 2;
    const pathData = `
 ...
 */
export function createRoundedRectangle(center, width, height, radius = 10, config) {
 ...
 */
export function createAngle(vertex, point1, point2, radius = 30, config) {
 ...
 */
export function createRightAngle(vertex, point1, point2, size = 15, config) {
 ...
 */
export function createAxes(center, width, height, config) {
 ...
 * Create number line
 */
export function createNumberLine(center, length, tickCount = 10, config) {
...
//# sourceMappingURL=AdvancedShapes.js.map