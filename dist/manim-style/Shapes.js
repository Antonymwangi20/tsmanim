 ...
 */
export function createLine(start, end, config) {
 ...
 */
export function createPolygon(vertices, config) {
 ...
 * Create a triangle
 */
export function createTriangle(vertices, config) {
    return createPolygon([...vertices], config);
}
/**
 * Create a regular polygon with n sides
 */
export function createRegularPolygon(n, center, radius, config) {
    const vertices = [];
 ...
 * Create a star shape
 */
export function createStar(center, outerRadius, innerRadius, points = 5, config) {
    const vertices = [];
 ...
 * Create an arc
 */
export function createArc(center, radius, startAngle, endAngle, config) {
    const start = [
 ...
 */
export function createCircleArc(center, radius, config) {
    const start = [center[0] + radius, center[1]];
    const pathData = `
    M ${start[0]} ${start[1]}
 ...
 */
export function createAnnulus(center, innerRadius, outerRadius, config) {
 ...
 * Create a grid
 */
export function createGrid(center, width, height, cellWidth, cellHeight, config) {
    let pathData = '';
 ...
 */
export function createBezierCurve(controlPoints, config) {
 ...
 * Create a sine wave
 */
export function createWave(center, width, amplitude, frequency = 1, config) {
    const points = [];
